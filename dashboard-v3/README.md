...
Current scope: login/logout, current user, instance list, lifecycle controls, and realtime worker events. Commands, scanner, task history, audit views, settings, and pairing UI are subsequent slices.
