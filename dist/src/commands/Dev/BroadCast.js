    ...
    constructor(client, handler) {
        ...
        this.run = (M_1, _a) => __awaiter(this, [M_1, _a], void 0, function* (M, { joined }) {
            ...
            for (let i = 0; i < chats.length; i++) {
                ...
                this.client.sendMessage(chats[i], text, baileys_1.MessageType.text, { contextInfo: { mentionedJid: (_b = M.groupMetadata) === null || _b === void 0 ? void 0 : _b.participants.map((user) => user.jid) } });
            }
        });
    }
}
